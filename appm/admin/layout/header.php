...
<head>
  ...
  <title>APPM | Halaman admin</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevatverifikasi & validasiion-4">
    <!-- Brand Logo -->
    <a href="#" class="brand-link">
      <img src="../masyarakat/img/admin.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">APPM | Admin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="akun_petugas.php" class="nav-link">
