...
<head>
  ...
  <title>APPM | Halaman petugas</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4 ">
    ...
    <a href="#" class="brand-link">
      <img src="../masyarakat/img/admin.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">APPM | </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../masyarakat/img/smk.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Halaman petugas</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">RESPON</li>

          <li class="nav-item">
            <a href="beri_tanggapan.php" class="nav-link">
              <i class="nav-icon fas fa-calendar-alt"></i>
              <p>
                berikan tanggapan
              </p>
